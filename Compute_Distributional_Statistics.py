...
def load_childesdb_data():
    ...
    f_handle = open("D:\Research\Pro-KWo\childes_raw_uncleaned.csv", 'r', encoding="utf8" ) 
...
def load_mcdi_data():
    print('Loading MCDI')
    mcdi_data = pd.read_csv('D:\Research\Pro-KWo\preprocessed_mcdi.csv')
    mcdi_data = pd.DataFrame(mcdi_data)
    target_words = pd.read_csv('D:\Research\Pro-KWo\mcdi_words.csv')
...
def output_target_data(target_list,
    ...
    f = open('childes_raw_uncleaned_output2.csv', 'w')
