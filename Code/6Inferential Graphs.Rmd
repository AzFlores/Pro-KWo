...
```{r}
# Assuming you have fitted the models model8, model8.1, model8.2, and model8.3
# ...
...
write.csv(stats_df, "my_table.csv",index)
...
figure5_data <- ggplot(data=stats_df, 
                       aes(x = Age,
                           y = Estimate, 
                           group = Predictor)) +
...
# Save the figure
ggsave(filename = here("figures_&_tables", "Figure 3. Single_Model_Estimates.jpeg"), plot = figure5_data, width = 11, height = 14)
```
...
write.csv(summary_df, file = here("data","interaction_models.csv"),row.names = F)
``` 
